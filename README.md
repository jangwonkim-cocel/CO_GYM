...
```python
import co_gym
env = co_gym.make(env_id='Quadrotor-v0')  # e.g., Ant-v4, Hopper-v4
```
...
algorithm = 'PPO'
my_config = {'load_model': True, 'load_checkpoint_dir': 'PPO_Quadrotor-v0_2024-07-15_23:37:55/checkpoint_3'}
